...
<head>
    <meta charset="UTF-8">
    <title>Bem Vindo ao curiousbooks!!!</title>
...
<body>
    ...
    <div class="content">
        ...
        <form class="search" method="POST">
            <div id="divBusca">
                <input type="text" name="pesquisar" id="usuario" placeholder="Buscar livro..." size="100%"/>
                <button id="btnBusca">Buscar</button>
            </div>
            <?php
            $pesquisar = @$_POST['pesquisar'];
            $result = "SELECT * FROM cad_livros WHERE nome LIKE '%$pesquisar%' OR FK_categ LIKE '%$pesquisar%'";
        ...
        <div class="page">
         <?php
            ...
            <section class="flex">
                <div class="recheio">
                    <img src="<?='./capas/'.$image?>">
                    <a href="inform-book.php?id=<?php echo $rows['id'];?>" class="btn"><br><button>Ler Agora</button></a>
                </div>
            </section>
            <?php } ?>
        <!-- Fim do Buscar-->
                ...
                <section class="flex">
                    <div class="recheio">
                        <img src="<?='./capas/'.$image?>">
                        <a href="inform-book.php?id=<?php echo $dados['id'];?>" class="btn"><br><button>Ler Agora</button></a>
                    </div>
                </section>
                <?php } ?>
            </div>
